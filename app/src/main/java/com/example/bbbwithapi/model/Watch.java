...
public class Watch implements Comparable<Watch> {
    ...
    public Watch(String ID, String UserID, String Name, String MobilePhone, String Division, Integer TanggalPiket, Integer BulanPiket, Integer TahunPiket,
    ...
    @Override
    public int compareTo(Watch another) {
