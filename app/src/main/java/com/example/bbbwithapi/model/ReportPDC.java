...
public class ReportPDC implements Comparable<ReportPDC> {
    @SerializedName("ID")
    @Expose
    private String ID;
    ...
    public ReportPDC(String ID, Integer BulanTransaksi, Integer TahunTransaksi, 
    ...
    @Override
    public int compareTo(ReportPDC another) {
